...
Your next stop would be at the [issues page](https://github.com/devcenter-square/disease-info-ui/issues). Here you can find a list of issues to fix as regards either the ongoing project, or bugs on the app.
